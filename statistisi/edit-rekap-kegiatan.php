                                        ...
                                        <form class="form form-horizontal" action="" method="POST" name="form3" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="custom-select form-control" name="unsur" onchange='changeValue(this.value)' id="unsur" value="">
                                                            ...
                                                            <?php
                                                            $query = mysqli_query($mysqli, "select * from data_unsur order by id_unsur asc");
                                                            $result = mysqli_query($mysqli, "select * from data_unsur");
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="custom-select form-control" name="unsur" onchange='changeValue(this.value)' id="unsur" value="">
                                                            ...
                                                            <?php
                                                            // $query = mysqli_query($mysqli, "select * from data_unsur order by id_unsur asc");
                                                            $result = mysqli_query($mysqli, "select * from data_subunsur");
                                                            $jsArray = "var prdName = new Array();\n";
                                                            while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="custom-select form-control" name="butir_kegiatan" onchange='changeValue(this.value)' id="data_butir" value="">
                                                            <option value="<?php echo $butir_kegiatan; ?>"><?php echo $butir_kegiatan; ?></option>
                                                            <?php
