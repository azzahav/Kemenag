...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">Kelola Pengguna</span><span class="user-status">Available</span></div><span><img class="round" src="../app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span>
                            </a>
    ...
    <form novalidate>
        ...
        <div class="controls">
        <label>NIP</label>
    <input type="text" class="form-control" placeholder="NIP" value="111111" required data-validation-required-message="This NIP field is required">
    </div>
    </div>
        <div class="form-group">
        <div class="controls">
        <label>Nama</label>
    <input type="text" class="form-control" placeholder="Nama" value="Angelo Sashington" required data-validation-required-message="This Nama field is required">
    </div>
    </div>
        <div class="form-group">
        <div class="controls">
        <label>No Seri</label>
    <input type="text" class="form-control" placeholder="No Seri" value="123456" required data-validation-required-message="This No Seri field is required">
    </div>
    </div>
    <div class="form-group">
        <div class="controls">
        <label>Pendidikan</label>
    <input type="text" class="form-control" placeholder="Pendidikan" value="S2" required data-validation-required-message="This Pendidikan field is required">
    </div>
    </div>
    </div>
    ...
    <div class="controls">
        <label>Pangkat</label>
    <input type="text" class="form-control" placeholder="Pangkat" value="Kepala" required data-validation-required-message="This Pangkat field is required">
    </div>
    </div>
    <div class="form-group">
    <div class="controls">
        <label>Jabatan</label>
    <input type="text" class="form-control" placeholder="Jabatan" value="Statistisi" required data-validation-required-message="This Jabatan field is required">
    </div>
    </div>
    <div class="form-group">
    <div class="controls">
        <label>Unit Kerja</label>
    <input type="text" class="form-control" placeholder="Unit Kerja" value="-" required data-validation-required-message="This Unit field is required">
    </div>
    </div>
    <div class="form-group">
    <div class="controls">
        <label>Role</label>
    <input type="text" class="form-control" placeholder="Role" value="-" required data-validation-required-message="This Role field is required">
    </div>
    </div>
    </div>
